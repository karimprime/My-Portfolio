...
blight.onclick = function LD() {
    ...
    cardh.style.background = '#f0f0f0';
    cardh.style.borderColor = '#f0f0f0';
    ph.style.color = '#222';
    ...
    cardi.style.background = '#f0f0f0';
    cardi.style.borderColor = '#f0f0f0';
    pi.style.color = '#222';
}
...
bdark.onclick = function DL() {
    ...
    cardh.style.background = '#222';
    cardh.style.borderColor = '#222';
    ph.style.color = '#f0f0f0';
    ...
    cardi.style.background = '#222';
    cardi.style.borderColor = '#222';
    pi.style.color = '#f0f0f0';
}
